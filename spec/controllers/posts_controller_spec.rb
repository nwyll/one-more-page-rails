...
RSpec.describe PostsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      get :show, params: { topic_id: my_topic.id, id: my_post.id, user_id: my_user.id }
  ...
  describe "GET #new" do
    it "returns a success response" do
      get :new, params: { topic_id: my_topic.id, user_id: my_user.id }
      expect(response).to be_success
    end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      get :edit, params: { topic_id: my_topic.id, id: my_post.id, user_id: my_user.id }
      expect(response).to be_success
    end
  ...
  describe "POST #create" do
    it "increases the number of Post by 1" do
      expect{
        post :create, params: { topic_id: my_topic.id, post: { body: Faker::Lorem.paragraph }, user_id: my_user.id }
...
wq  end
   ...
   describe "DELETE destroy" do
    it "deletes the requested post" do
      delete :destroy, params: { topic_id: my_topic.id, id: my_post.id, user_id: my_user.id }
